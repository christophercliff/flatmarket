...
var OPTIONS_SCHEMA = Joi.object().keys({
    ...
    theme: Joi.string().default(path.resolve(__dirname, './themes/default/')),
}).required()
var PROTOCOL = 'https'
...
function getCompiler(options) {
    ...
    return webpack(_.merge(config, {
        ...
        resolve: {
            alias: {
                __component__$: path.resolve(options.theme, 'index.jsx'),
            },
        },
        resolveLoader: {
...
function getMarkup(options, data) {
    ...
    var Component = require(path.resolve(options.theme, 'index.jsx'))
