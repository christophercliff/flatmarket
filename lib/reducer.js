...
function handleUpdateStatusBegin(state) {
    return state.set('statusOfServer', STATUSES.begin.id)
}

function handleUpdateStatusFailure(state) {
    return state.set('statusOfServer', STATUSES.failure.id)
}

function handleUpdateStatusSuccess(state) {
    return state.set('statusOfServer', STATUSES.success.id)
}
